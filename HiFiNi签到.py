...
def get_sign_value(cookies):
    ...
    if matches:
        ...
        if '登录后查看' in response.text:
            print("[-] Cookie失效")
            notify.send("hifini 签到异常", "Cookie失效")
            return None
...
if __name__ == "__main__":
    ...
    if sign:
        ...
        notify.send("hifini 签到异常", "hifini 签到失败：没有获取到签名，请联系开发人员")
